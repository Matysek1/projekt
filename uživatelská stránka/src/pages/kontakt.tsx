        ...
        <div className="relative z-10 container mx-auto px-4 py-24">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed">
              Máte zájem o spolupráci, máte dotaz nebo potřebujete poradit? Napište mi a rád vám pomohu.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-white rounded-xl shadow-sm p-8">
              <h2 className="text-2xl font-bold mb-6 text-gray-900">Napište mi</h2>
            ...
            <div className="space-y-8">
              <div className="bg-white rounded-xl shadow-sm p-8">
                <h2 className="text-2xl font-bold mb-6 text-gray-900">Kontaktní údaje</h2>
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@vasedomena.cz</p>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-xl shadow-sm p-8">
                <h2 className="text-2xl font-bold mb-6 text-gray-900">Sledujte mě</h2>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-8 border border-blue-100">
                <h3 className="text-xl font-bold mb-3 text-gray-900">Rychlá odpověď</h3>
                <p className="text-gray-700 mb-4">
                  Obvykle odpovídám na e-maily do 24 hodin. Pro urgentní záležitosti mě kontaktujte telefonicky.
                </p>
